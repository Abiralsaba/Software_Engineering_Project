...
export default function PassportPage() {
  ...
  return <CitizenShell ministry="passport" sections={sections} activeSection={section} onSectionChange={setSection}>

    <nav className="react-service-tabs nx-section-tabs" aria-label="Passport sections">{sections.map(value => <button type="button" className={section === value ? 'active' : ''} onClick={() => setSection(value)} key={value}>{value}</button>)}</nav>
